    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 xl:grid-cols-[1.3fr_0.7fr]">
        ...
        <div className="space-y-5">
          ...
          <Card><CardHeader><h2 className="text-sm font-semibold">Contato</h2></CardHeader><CardContent className="space-y-3 text-xs"><Info icon={Phone} label="Telefone" value={lead.phoneValue ?? "Não informado"} /><Info icon={MessageCircle} label="WhatsApp" value={lead.whatsappValue ?? "Não informado"} /><Info icon={AtSign} label="Instagram" value={lead.instagramValue ?? "Não informado"} /><Info icon={MapPin} label="Endereço" value={lead.address ?? lead.location} /><Info icon={CalendarClock} label="Follow-up" value={lead.nextFollowUp ?? "Não agendado"} /></CardContent></Card>
