...
export default function IntegrationsPage() {
  const integrations = [
    ...
    { name: "OpenStreetMap / Nominatim + Overpass", description: "Localiza cidades e pesquisa temporariamente profissionais e negócios por categoria, sem chave de API.", icon: MapPinned, active: true },
